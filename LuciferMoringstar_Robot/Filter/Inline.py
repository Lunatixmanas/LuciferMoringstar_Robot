...
def get_reply_markup(query):
    buttons = [[
        InlineKeyboardButton('Support Group', url='t.me/KOT_REPORS'),
        InlineKeyboardButton('More BotS', url='t.me/KOT_BOTS')
        ],[
        InlineKeyboardButton('🖥️ FOLLOW ON YOUTUBE 🖥️', url=f'{TUTORIAL}')
        ],[
